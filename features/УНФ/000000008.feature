...
* Сценарий: Расширенная гарантия
	...
	И я запоминаю строку "Истина" в переменную "РаботаСоСменой"
	Если переменная "РаботаСоСменой" имеет значение "Истина" Тогда
	...
	//Добавить проверку печатной формы, похоже проблема с платформой
